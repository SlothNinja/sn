...
func NewKey(id int64) *datastore.Key {
	return datastore.IDKey(kind, id, UserRootKey())
}
...
func (client *UserClient) Update(c *gin.Context, cu, u1, u2 *User) error {
...
func (client *UserClient) updateName(c *gin.Context, u *User, n string) error {
...
func (client *UserClient) NameIsUnique(c *gin.Context, name string) (bool, error) {
...
func (client *UserClient) getFiltered(c *gin.Context, start, length string) ([]*User, int64, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) Current(c *gin.Context) (*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) Get(c *gin.Context, id int64) (*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) get(c *gin.Context, k *datastore.Key) (*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) mcGet(k *datastore.Key) (*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) mcGetMulti(ks []*datastore.Key) ([]*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) dsGet(c *gin.Context, k *datastore.Key) (*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) dsGetMulti(c *gin.Context, ks []*datastore.Key) ([]*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) cacheUser(u *User) {
	if u.Key == nil {
		return
	}
...
func (client *UserClient) GetMulti(c *gin.Context, ids []int64) ([]*User, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) AllocateIDs(c *gin.Context, ks []*datastore.Key) ([]*datastore.Key, error) {
	return client.DS.AllocateIDs(c, ks)
}

func (client *UserClient) Put(c *gin.Context, k *datastore.Key, u *User) (*datastore.Key, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) putUserByKey(c *gin.Context, k *datastore.Key, u *User) (*datastore.Key, error) {
	client.Log.Debugf(msgEnter)
	defer client.Log.Debugf(msgExit)
...
func (client *UserClient) RunInTransaction(c *gin.Context, f func(*datastore.Transaction) error, opts ...datastore.TransactionOption) (*datastore.Commit, error) {
