...
func (cl Client) Auth(path string) gin.HandlerFunc {
	return func(c *gin.Context) {
...
func (cl Client) As(c *gin.Context) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client) getOAuth(c *gin.Context, id string) (OAuth, error) {
	return cl.getOAuthByKey(c, NewOAuthKey(id))
}

func (cl Client) getOAuthByKey(c *gin.Context, k *datastore.Key) (OAuth, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client) cacheOAuth(oauth OAuth) {
	if oauth.Key == nil {
		return
	}
...
func (cl Client) getByEmail(c *gin.Context, email string) (User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func LoginHandler(cl Client) gin.HandlerFunc {
...
func LogoutHandler(cl Client) gin.HandlerFunc {
	return func(ctx *gin.Context) {
		cl.Log.Debugf(msgEnter)
		defer cl.Log.Debugf(msgExit)
