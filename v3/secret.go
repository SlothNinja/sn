...
//	}
func (cl Client[G, P]) getSecrets(c context.Context) (*Secret, error) {
...
func (cl Client[G, P]) mcGetSecrets() (*Secret, bool) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) dsGetSecrets(c context.Context) (*Secret, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) updateSecrets(c context.Context) (*Secret, error) {
	s, err := GenSecrets()
	if err != nil {
		return nil, err
	}
