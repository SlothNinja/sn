...
func (cl Client[G, I]) StackDocRef(id string, uid UID) *firestore.DocumentRef {
	return cl.StackCollectionRef().Doc(fmt.Sprintf("%s-%d", id, uid))
}

func (cl Client[G, I]) StackCollectionRef() *firestore.CollectionRef {
...
func (cl Client[G, I]) GetStack(ctx *gin.Context, uid UID) (s Stack, err error) {
