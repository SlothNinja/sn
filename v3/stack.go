...
func (cl Client) StackDocRef(id string, uid UID) *firestore.DocumentRef {
	return cl.StackCollectionRef().Doc(fmt.Sprintf("%s-%d", id, uid))
}

func (cl Client) StackCollectionRef() *firestore.CollectionRef {
...
func (cl Client) GetStack(ctx *gin.Context, uid UID) (s Stack, err error) {
