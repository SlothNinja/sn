...
func (cl Client[G, P]) Update(c *gin.Context, cu, u1, u2 User) error {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) updateName(c *gin.Context, u User, n string) error {
...
func (cl Client[G, P]) NameIsUnique(c *gin.Context, name string) (bool, error) {
...
func (cl Client[G, P]) getFiltered(c *gin.Context, start, length string) ([]User, int64, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) Current(c *gin.Context) (User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) Get(c *gin.Context, uid UID) (User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) get(c *gin.Context, k *datastore.Key) (User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) mcGet(k *datastore.Key) (User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) mcGetMulti(ks []*datastore.Key) ([]User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) dsGet(c *gin.Context, k *datastore.Key) (User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) dsGetMulti(c *gin.Context, ks []*datastore.Key) ([]User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) cacheUser(u User) {
	if u.Key == nil {
		return
	}
...
func (cl Client[G, P]) GetMulti(c *gin.Context, uids []UID) ([]User, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) Put(c *gin.Context, k *datastore.Key, u User) (*datastore.Key, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
...
func (cl Client[G, P]) putUserByKey(c *gin.Context, k *datastore.Key, u User) (*datastore.Key, error) {
	cl.Log.Debugf(msgEnter)
	defer cl.Log.Debugf(msgExit)
